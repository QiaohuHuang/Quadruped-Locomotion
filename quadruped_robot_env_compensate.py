...
import time
from test_robot_evolution_algorithm import sin_wave, load_parameters
...
class QuadrupedRobotEnv(gym.Env):
    def __init__(self, use_GUI=True, verbose=True):
        ...
        self.action_space = spaces.Box(low=-0.2, high=0.2, shape=(4,), dtype=np.float32)
    ...
    def step(self, action):
        ...
        base_action = np.array([
            sin_wave(params["amplitude"], params["frequency"], params["phase"], self.num_step*240)
...
if __name__ == "__main__":
    ...
    # joint_position = observation[18: 30]
    joint_position = observation[18: 26]
